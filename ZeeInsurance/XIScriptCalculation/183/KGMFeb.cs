...
namespace ZeeInsurance.XIScriptCalculation._183
{
    public class KGMFeb
    {
        //public static CResult PolicyMainCal(int iInsatnceID, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sProductCode, string sVersion, string sSessionID, string sUID, int iQuoteID)
