...
namespace ZeeInsurance.XIScriptCalculation._88
{
    public class MTAKGM
    {
        public static CResult PolicyMainCal(List<CNV> lParam)
        {
            ...
            try
            {
                ...
                oIB.SaveErrortoDB(oResult);
                oResult = Pcal.Calculation(oQsInstance, iUserID, iCustomerID, sDataBase, sProductName, sVersion, dCoverStart, rGrossPremium);
                oNV.sValue = "00";
            }
            catch (Exception ex)
            {
        ...
        public abstract class PolicyBaseCalc
        {
            ...
            public static string GetPostCodeLookUp(string PostCode, int EngineSize, string sDataBase, string sProductName, string sVersion)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oResult = new CResult();
                oResult.sMessage = "Enginesize_" + EngineSize;
                oIB.SaveErrortoDB(oResult);
                oResult.sMessage = "sDataBase_" + sDataBase;
                oIB.SaveErrortoDB(oResult);
                oResult.sMessage = "PostCode" + PostCode;
                oIB.SaveErrortoDB(oResult);
                oResult.sMessage = "sProductName_" + sProductName;
                oIB.SaveErrortoDB(oResult);
                oResult.sMessage = "sVersion_" + sVersion;
                oIB.SaveErrortoDB(oResult);
                ...
                if (PostCodeGroup.xiStatus == 0 && PostCodeGroup.oResult != null)
                {
                    ...
                    {
                        oResult.sMessage = "PostCode_" + Area;
                        oIB.SaveErrortoDB(oResult);
                        res = Area;
                    }
                    else
                    {
                        ...
                        res = Area + Group;
                        oResult.sMessage = "PostCodeWithEngine_" + res;
                        oIB.SaveErrortoDB(oResult);
                    }
                }
                return res;
            ...
            public CResult GetUseLoadFactor(string sCaravanUsedforAnythingOtherThanPersonalHoliday)
            {
                CResult oresult = new CResult();
                try
                {
                    ...
                    oNV2.sName = "LoadFactorName";
                    oNV2.sValue = "Usage";
                    if (sCaravanUsedforAnythingOtherThanPersonalHoliday.ToLower() == "yes")
                    {
                        oNV1.sValue = "+20";
                    }
                    oresult.oCollectionResult.Add(oNV);
            ...
            public CResult GetOwnershipDiscount(int YearOfOwnerShip)
            {
                ...
                try
                {
                    ...
                    if (DateTime.Now.Year - YearOfOwnerShip == 1)
                    {
                        oNV1.sValue = "-5";
                    }
                    else if (DateTime.Now.Year - YearOfOwnerShip == 2)
                    {
                        oNV1.sValue = "-10";
                    }
                    else if (DateTime.Now.Year - YearOfOwnerShip == 3)
                    {
                        oNV1.sValue = "-15";
                    }
                    else if (DateTime.Now.Year - YearOfOwnerShip == 4)
                    {
                        oNV1.sValue = "-20";
                    }
                    else if (DateTime.Now.Year - YearOfOwnerShip >= 5)
                    {
                        oNV1.sValue = "-25";
                    }
                    oresult.oCollectionResult.Add(oNV);
            ...
            public CResult GetDrivingDiscount(string type)
            {
                ...
                try
                {
                    ...
                    type = type.ToLower();
                    if (type == "insured only driving")
                    {
                        oNV1.sValue = "-15";
                    }
                    else if (type == "insured & spouse")
                    {
                        oNV1.sValue = "-25";
                    }
                    oresult.oCollectionResult.Add(oNV);
            ...
            public CResult GetAgeFromDOB(string dDOB)
            {
                ...
                try
                {
                    if (dDOB.Contains('/'))
                    {
                        var datearray = dDOB.Split('/');
                        dDOB = datearray[1] + "/" + datearray[0] + "/" + datearray[2];
                    }
        ...
        {
            public CResult Calculation(XIIQS QSInstance, int iUserID, int iCustomerID, string sDataBase, string sProductName, string sVersion, string dCoverStart, string rGrossPremium)
            {
                XIInstanceBase oIB = new XIInstanceBase();
                CResult oResult = new CResult();
                try
                {
                    ...
                    string TypeOfCover = ostructureInstance.XIIValue("sTypeofCover").sValue;
                    if (sEnigine != null)
                    {
                    ...
                    string iYearOfManufacture = ostructureInstance.XIIValue("iYearOfManufacture").sValue;
                    ...
                    string iYearOfOwnership = ostructureInstance.XIIValue("iYearOfOwnership").sValue;
                    string sTypeOfDriving = ostructureInstance.XIIValue("sTypeOfDriving").sValue;
                    ...
                    string sCaravanUsedforAnythingOtherThanPersonalHoliday = ostructureInstance.XIIValue("sCaravanUsedforAnythingOtherThanPersonalHoliday").sValue;
                    string sCaravanNoClaimsDiscount = ostructureInstance.XIIValue("sCaravanNoClaimsDiscount").sValue;
                    ...
                    var oUseageLoadFactor = PolicyCal.GetUseLoadFactor(sCaravanUsedforAnythingOtherThanPersonalHoliday);
                    ...
                    var oDrivingDiscountLoadFactor = PolicyCal.GetDrivingDiscount(sTypeOfDriving);
                    ...
                    if (iYearOfOwnership != null)
                    {
                        var oOwnerShipDiscountLoadFactor = PolicyCal.GetOwnershipDiscount(Convert.ToInt32(iYearOfOwnership));
                    ...
                    {
                        var oNoClaim = PolicyCal.GetNoClaimsDiscount(Convert.ToInt32(sCaravanNoClaimsDiscount));
                        if (oNoClaim.xiStatus == 0 && oNoClaim.oCollectionResult != null)
                        {
                            oXiResults.Add(oNoClaim);
                        }
                        var oProtectedNoClaimDiscountLoadFactor = PolicyCal.GetProtectedNoClaimsDiscount(Convert.ToInt32(sCaravanNoClaimsDiscount));
                    ...
                    if (oXiResults.All(m => m.oCollectionResult.Where(x => x.sName == "sMessage").All(x => x.sValue == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())) && oExcessVal.oCollectionResult.Where(m => m.sName == "sMessage").Select(m => m.sValue).FirstOrDefault() == xiEnumSystem.xiEnumPolicyLookupResponses.Normal.ToString())
                    {
                        ...
                        total = PolicyCal.GetNetAmount(TypeOfCover, total);
                        ...
                        {
                            total += ((Convert.ToDouble(IPTLoadFactor.oCollectionResult.Where(m => m.sName == "oResult").Select(m => m.sValue).FirstOrDefault()) * 0.01) * BaseLoad);
                        }
                        total = total / 365 * leftoverdays - BalAmount;
                        var oAdditionalCharges = PolicyCal.GetAdditionalCharges();
                        if (oAdditionalCharges.xiStatus == 0 && oAdditionalCharges.oCollectionResult != null)
                        {
                            total = total + Convert.ToDouble(oAdditionalCharges.oCollectionResult.Where(m => m.sName == "oResult").Select(m => m.sValue).FirstOrDefault());
                        }
                    ...
                    oBII.Attributes["UpdatedTime"] = new XIIAttribute { sName = "UpdatedTime", sValue = DateTime.Now.ToString("dd-M-yy"), bDirty = true };
                    ...
                    oBO.Attributes["sMessage"] = new XIIAttribute { sName = "sMessage", sValue = "", bDirty = true };
