...
$(document).ready(function () {
    ...
    $(function() {
        ...
        $.ajax({
            url: url + '/api/Lead/GetFlotChatsDetails',
            type: 'GET',
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, item) {
                        ...
                        arrVisit = [];
                        arrVisit.push(item.X);
                        arrVisit.push(parseInt(item.Y));
                        ArrayList.push(arrVisit);
    ...
    $(function() {
        ...
        //};
        $.ajax({
            url: url + '/api/Lead/GetFlotLineDetails',
            type: 'GET',
            contentType: "application/json; charset=utf-8",
            datatype: 'JSON',
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (index, item) {
                        debugger
                        arrVisit = [];
                        arrVisit.push(item.ConvertedLineChart[i].X);
                        arrVisit.push(parseInt(item.ConvertedLineChart[i].Y));
                        ArrayList.push(arrVisit);
                        i++;
