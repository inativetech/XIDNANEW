...
{
    public class XIBNPFileWrapperLive
    {
        public XIBNPFileWrapperLive()
        {
        }
...
"MMM-dd-yyyy","MM-dd-yyyy", "MM.dd.yyyy", "MMM.dd.yyyy", "MM/dd/yyyy"
        ...
        public XIPFCResult LoadXIBNPAPI(EnumXIBNPMethods enummethod, string xmlinput, Dictionary<string, XIPFfields> pffieldslist)
        {
            ...
            dynamic xibnpapi = GetInstance<XIBNPAPILive>();
            ...
            try
            {
                ...
                if (EnumXIBNPMethods.NewBusiness == requestedservice)
                {
                    ...
                    policy.PreferredPaymentDay = InputObj.GetXIPFValue("PreferredPaymentDay" + strpostfix).iValue == 0 ?
                        DateTime.Now.Day > 28 ? 28 : DateTime.Now.Day : InputObj.GetXIPFValue("PreferredPaymentDay" + strpostfix).iValue;
    ...
    //    #region Enums
    //    private enum EnumxiStatus
    //    {
    //        sucess, error
    //    }

    //    private enum EnumXIBNPMethods
    //    {
    //        None = 0,
    //        LiveRateQuote = 1,
    //        NewBusiness = 2,
