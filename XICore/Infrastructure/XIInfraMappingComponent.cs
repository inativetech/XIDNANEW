            ...
            try
            {
                ...
                if(i1ClickID > 0)
                {
                    ...
                    foreach(var items in BOIs)
                    {
                        ...
                        oNVs.Add(new CNV { sName = Name, sValue = ID });
                    }
                    Result.Add("LeftValues", oNVs);
                    if (Ri1ClickID > 0)
                    {
                        var Ro1ClickD = (XID1Click)oCache.GetObjectFromCache(XIConstant.Cache1Click, null, Ri1ClickID.ToString());
                        ...
                        List<CNV> RoNVs = new List<CNV>();
                        foreach (var items in RBOIs)
                        {
                            var ID = items.AttributeI("id").sValue;
                            var Name = items.AttributeI("sname").sValue;
                            RoNVs.Add(new CNV { sName = Name, sValue = ID });
                        }
                        Result.Add("RightValues", RoNVs);
                    }
