...
namespace XICore
{
    public class XIInfraQSLinkComponent
    {
        ...
        public CResult XILoad(List<CNV> oParams)
        {
            ...
            try
            {
                ...
                oLink.ID = ID;
                oLink.FKiApplicationID = iApplicationID;
                var oQSLink = oLink.Get_QSLinkDetails();
                if (oQSLink.bOK && oQSLink.oResult != null)
                {
                    oLink = (XIQSLink)oQSLink.oResult;
                    oLink.ddlQSLinkCodes = new List<XIDropDown>();
                    oLink.ddlQuestionSets = new List<XIDropDown>();
                    oLink.ddlQSStteps = new List<XIDropDown>();
                    oLink.ddlSections = new List<XIDropDown>();
                }
                //oLink.ddlApplications = oConfig.Get_AllApplications();
