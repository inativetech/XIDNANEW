...
namespace XICore
{
    public class XIInfraXIComponentComponent
    {
        ...
        public CResult XILoad(List<CNV> oParams)
        {
            ...
            try
            {
                ...
                XIDComponent oFDef = new XIDComponent();
                XIDXI oXD = new XIDXI();
                oXD.FKiApplicationID = iApplicationID;
                var oComDef = oXD.Get_ComponentDefinition("", ID.ToString());
                if (oComDef.bOK && oComDef.oResult != null)
                {
                    oFDef = (XIDComponent)oComDef.oResult;
                }
